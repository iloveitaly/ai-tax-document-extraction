"""
1099-B is a tax form, but it lands on Schedule D and 8494.
"""
...
# TODO types do not get threaded through here
get_field_descriptions = fp.partial(
    ...
    "1099_b_field_descriptions",
)


# TODO should convert this into a partial
...
def generate_prompt(user_data: dict, image_text: str) -> str:
    ...
    rules = ["This image and document text represents a 1099-B US tax document."]
